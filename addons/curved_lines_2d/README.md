...
[`res://addons/curved_lines_2d/examples/import_svg_at_runtime/`](./examples/import_svg_at_runtime/)
...
![SyncedSVGRoot in the inspector](./screenshots/synced-svg-root-inspector.png)
...
![knife tool](./screenshots/knife.gif)
